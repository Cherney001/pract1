...
class PersonRepository
  ...
  def by_part_name(part_of_name)
    @people.select { |person| person.first_name.include?(part_of_name) || person.last_name.include?(part_of_name) }
  end
  ...
  def edit(inn, updated_person)
    ...
    raise "Person not found" if person_to_edit.nil?
  ...
  def delete(person)
    ...
    raise "Person not found" if person_to_remove.nil?
